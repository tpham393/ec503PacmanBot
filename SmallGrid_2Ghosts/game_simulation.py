...
ghost_y = [2,3];
numGhosts = 2;
game.updateState(pacman_x, pacman_y, ghost_x, ghost_y, numGhosts, ghostType) # update internal grid
...
while not game.ended:
    ...
    state = coord2state(game.pacman_x, game.pacman_y, game.ghost_x, game.ghost_y, numGhosts, grid_len);
    print(state)
    ...
    pacman_x2, pacman_y2, ghost_x2, ghost_y2, game.goal_x, game.goal_y, game.ended, game.won = g.game_func(move, game.pacman_x, game.pacman_y, game.ghost_x, game.ghost_y, game.goal_x, game.goal_y, game.grid, numGhosts, ghostType);
    game.moves.append(move);
    game.updateState(pacman_x2, pacman_y2, ghost_x2, ghost_y2, numGhosts, ghostType); # update internal grid
