    ...
    def update(self):
        ...
        if not ended:
            ...
            for event in pygame.event.get():
                ...
                if key[pygame.K_1] and not (pacman_y - 1 == -1):
                    pacman[pacman_y][pacman_x]='False'
                    pacman_y = pacman_y - 1;
                    pacman[pacman_y][pacman_x]='True'
                    self.ghost_move()
                    self.win_check()
                elif key[pygame.K_2] and not (pacman_x + 1 == gridsize[0]):
                    pacman[pacman_y][pacman_x]='False'
                    pacman_x = pacman_x + 1;
                    pacman[pacman_y][pacman_x]='True'
                    self.ghost_move()
                    self.win_check()
                elif key[pygame.K_3] and not (pacman_y + 1 == gridsize[1]):
                    pacman[pacman_y][pacman_x]='False'
                    pacman_y = pacman_y + 1;
                    pacman[pacman_y][pacman_x]='True'
                    self.ghost_move()
                    self.win_check()
                elif key[pygame.K_4] and not (pacman_x - 1 == -1):
                    pacman[pacman_y][pacman_x]='False'
                    pacman_x = pacman_x - 1;
                    pacman[pacman_y][pacman_x]='True'
                    self.ghost_move()
